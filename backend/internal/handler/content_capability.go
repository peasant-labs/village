...
func advertisedContentCapabilitiesWithEvaluator(evaluator observedModelPreservationEvaluator) []schema.ContentCapability {
	...
	return []schema.ContentCapability{schema.ContentCapabilityDetailedUsageV1, schema.ContentCapabilityNativeMetadataV1, schema.ContentCapabilityObservedModelV1}
}
